...
<html lang="en">
  ...
  <body>
    <!-- 1ST NAVIGATION -->
    <nav
      class="navbar navbar-expand-lg navbar navbar-dark"
    ...
    <div class="container">
      ...
      <header class="healthcarePod">REGISTER</header>
      ...
      <div class="row">
          <div class="col-md-6 offset-md-3">
            <form action="includes/register-inc.php" method="post" id="contactForm">
              ...
              <div class="form-group row">
                <label for="f_password" class="col-sm-3 col-form-label"
                  >Password:</label
                >
                <div class="col-sm-9">
                  <input
              ...
              <div class="form-group row">
                  <label for="f_confirmPassword" class="col-sm-3 col-form-label"
                ...
                <div class="form-group row">
                    <label for="f_register" class="col-sm-3 col-form-label"
                    ></label
                  >
                    <div class="col-sm-9">
                        <button 
    ...
    <!-- <script src="./js/top-five.js"></script> -->
  </body>
</html>
